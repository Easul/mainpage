(function(f, h) {
    ...
    $.extend(!0, a, {
        switchBtnObj: function(a, c) {
            ...
            b.locked = !1;
            b.callback = c;
            b.toggleBtn = b.view.find(".proxy-toggle-btn");
            b.textSwitch = b.view.find(".proxy-text-switch");
            b.checkedSwitch = b.view.find(".proxy-checked-switch");
    ...
    $.extend(!0, a, {
        ...
        saveSiteProxyListForm: function(e) {
            a.setValue("SITE_PROXY_LIST_FORM", e)
        },
        getSiteProxyListForm: function() {
            return a.getValue("SITE_PROXY_LIST_FORM")
        },
    ...
    $.extend(!0, a, {
        ...
        get_search_hint_list: function(d) {
            ...
            case "bing":
                ...
                break;
            case "google":
                var r = $(".proxy-toggle-btn").hasClass("toggle-btn-checked");
                if (r) {
        ...
        get_duckduckgo_proxy_search_hint_list: function(d, b, c) {
            a.search_keyword = b;
            jQuery.ajax({
                url: d,
                type: "get",
        ...
        get_duckduckgo_proxy_search_hint_list_callback: function(d) {
            d = eval(d);
            "undefined" == typeof d && (d = ["", []]);
            a.handle_search_hint_list(d[1])
        },
    ...
    $.extend(!0, a, {
        ...
        init: function() {
            ...
            function() {
                ...
                NavSite.siteListProxySwitchBtn.init();
